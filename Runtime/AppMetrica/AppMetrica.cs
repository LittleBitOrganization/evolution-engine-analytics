...
public class AppMetrica : MonoBehaviour
{
    ...
    public static AppMetrica Init()
    {
        return new GameObject("AppMetrica").AddComponent<AppMetrica>();
    }
    ...
    public void SetupMetrica(
        string apiKey, 
        uint sessionTimeoutSec = 10, 
        bool enableLogs = false, 
        bool handleFirstActivationAsUpdate = false, 
        bool statisticsSending = true, 
        bool locationTracking = false,
        bool exceptionsReporting = true)
    {
        
        ExceptionsReporting = exceptionsReporting;
